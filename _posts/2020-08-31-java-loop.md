...
메서드 내부의 첫 번째 라인을 보면 [Iterable](https://docs.oracle.com/javase/8/docs/api/java/lang/Iterable.html) 인터페이스를 구현한 객체가 iterator() 메서드로 [Iterator](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html) 인터페이스를 구현한 객체를 반환한다.
