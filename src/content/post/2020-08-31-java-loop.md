...
다만 이 forEach 메서드를 사용할 땐 주의해야 하는 점이 있다. 그 내용은 [Stream의 foreach 와 for-loop 는 다르다.](https://woowacourse.github.io/tecoble/2020-05-14-foreach-vs-forloop) 이 글을 통해 학습하는 것을 추천한다.
