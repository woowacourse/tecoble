...
Controller는 View와 도메인 Model의 데이터를 주고 받을 때 별도의 **DTO** 를 주로 사용합니다. 도메인 객체를 View에 직접 전달할 수 있지만, 민감한 도메인 비즈니스 기능이 노출될 수 있으며 Model과 View 사이에 의존성이 생기기 때문입니다. 물론 프로젝트가 및 특성에 따라 [DTO 사용이 불필요한 경우](http://guntherpopp.blogspot.com/2010/09/to-dto-or-not-to-dto.html)도 있습니다.
